...
export const adminAiService = {
  /** GET /api/admin/ai/analytics — xem thống kê AI */
  ...
  /** GET /api/admin/ai/knowledge-base — danh sách knowledge base */
  ...
  /** POST /api/admin/ai/knowledge-base — thêm knowledge base */
  ...
  /** PUT /api/admin/ai/knowledge-base/{id} — cập nhật knowledge base */
  ...
  /** DELETE /api/admin/ai/knowledge-base/{id} — xóa knowledge base */
  ...
  /** PUT /api/admin/ai/settings/{key} — cập nhật cấu hình AI */
  async updateSetting(
    key: string,
    value: string,
  ): Promise<{ success: boolean; message: string }> {
